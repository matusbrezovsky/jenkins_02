...
@echo on
python -m robot.run -N "Demo"  -e MandatoryManualSteps %NO_DEV% -v DEVELOPMENT_MODE:False -v DLGS_SKIP:True -v DLGS_SLEEP:15s -b debug_all.log  --output out_mss_all.xml  -P src\bin -P src\py src\test\atf\tests\demo\Demo.robot
@echo off
