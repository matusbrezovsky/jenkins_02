...
MMC_3G
    ...
    run appium  Demo1   port=4700   address=127.0.0.1   optional_args= --log-level warn --bootstrap-port 4801 --command-timeout 400 
    run appium  Demo2   port=4701   optional_args= --log-level warn 
    ${ms_a} =           Set Variable    ${MsDemo1}
